<?php /* Smarty version 3.1.27, created on 2017-11-22 09:50:56
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/appresourcegroup_bind.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:6560270585a14d8001962f6_22539319%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95abc8047d87dc02059ce05c865f3590dae72861' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/appresourcegroup_bind.tpl',
      1 => 1474793221,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6560270585a14d8001962f6_22539319',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5a14d8002a85a1_32897469',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5a14d8002a85a1_32897469')) {
function content_5a14d8002a85a1_32897469 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '6560270585a14d8001962f6_22539319';
?>
...
>
function searchit(){
	var url = "admin.php?controller=admin_app&action=appresourcegroup_bind&id=<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
";
...
/images/an33.jpg" align="absmiddle"/></li>
</ul><span class="back_img"><A href="admin.php?controller=<?php if ($_smarty_tpl->tpl_vars['fromapp']->value == 'search') {?>admin_pro&action=app_priority_search<?php } else { ?>admin_app&action=app_group<?php }?>&back=1"><IMG src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/back1.png" 
  ...
  <tr>
	<td class=""><table width="100%" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            <td align="center"><form name="f1" method=post action="admin.php?controller=admin_app&action=appresourcegroup_bindsave&id=<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
">
...
">
	&nbsp;&nbsp;<input  type="button" value=" 搜索 " onclick="searchit();" class="bnnew2">
	  ...
	  <tr><td align="right">组名</td><td><?php echo $_smarty_tpl->tpl_vars['ginfo']->value['appgroupname'];?>
</td></tr>
	  <tr><td align="right">已绑定资源数</td><td><?php echo $_smarty_tpl->tpl_vars['ginfo']->value['devicesct'];?>
</td></tr>
