<?php /* Smarty version 3.1.27, created on 2017-11-23 14:32:40
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/vpn/template/admin/login.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:12893935145a166b883b1ec6_78353705%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '12893935145a166b883b1ec6_78353705',
  'variables' => 
  array (
    'template_root' => 0,
    'dpwdtime' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5a166b884db6e9_70244026',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5a166b884db6e9_70244026')) {
function content_5a166b884db6e9_70244026 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '12893935145a166b883b1ec6_78353705';
?>
...
<input type="text" name="username" id="username"  onblur="changeusername(this.value,'u');" <?php if ($_smarty_tpl->tpl_vars['nametype']->value == 'realname') {?>disabled='disabled'<?php }?>  style="width: <?php if (!$_smarty_tpl->tpl_vars['logintype']->value['ldapauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['radiusauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['adauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['fingersecauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['localfingersecauth'] || !$_smarty_tpl->tpl_vars['loginauthtype']->value || !$_smarty_tpl->tpl_vars['loginauthtype']->value) {?>145<?php } else { ?>100<?php }?>px;<?php if (!$_smarty_tpl->tpl_vars['dpwdtime']->value) {?>height:24px;<?php }
...
<select name='username' id="realname" disabled style="width: <?php if (!$_smarty_tpl->tpl_vars['logintype']->value['ldapauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['radiusauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['adauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['fingersecauth'] && !$_smarty_tpl->tpl_vars['logintype']->value['localfingersecauth'] || !$_smarty_tpl->tpl_vars['loginauthtype']->value || !$_smarty_tpl->tpl_vars['loginauthtype']->value) {?>145<?php } else { ?>100<?php }?>px;<?php if (!$_smarty_tpl->tpl_vars['dpwdtime']->value) {?>height:24px;<?php }?>display:none">
...
<?php }?>
  ...
  <object id='TLFPAPICtrl' name='TLFPAPICtrl' width="98px" height="85px" classid="CLSID:21F80267-6D19-432B-B9C2-83C8407FA34A" style="padding-top:-40px;" >
	<param name="CtrlType" value="02">					
   </object>
</div>
<?php echo '<script'; ?>
 type='text/javascript'>
var obj = document.getElementById("TLFPAPICtrl");
function getdata()
{
  var fp = obj.GetFingerData();
  if(fp==""){
    alert('没采集到指纹数据');
    return ;
  }
  document.getElementById("fpdata").value= fp;
  if(confirm('是否登录？'))
    document.getElementById("doAmsForm").submit();
}
obj.attachEvent("onGetFeature", getdata);
<?php echo '</script'; ?>
>
