<?php /* Smarty version 3.1.27, created on 2017-11-23 14:32:47
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/vpn/template/admin/status_latest.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:7358122215a166b8f6628e1_56381761%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '7358122215a166b8f6628e1_56381761',
  'variables' => 
  array (
    'language' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5a166b8f845895_10634706',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5a166b8f845895_10634706')) {
function content_5a166b8f845895_10634706 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '7358122215a166b8f6628e1_56381761';
?>
...
&graphtype=pie"></TD>
 ...
 <tr><td colspan="2">
     <DIV id="navbar1" style="width: 100%;">
            <DIV id="header1">
            <UL>
              <LI id="current1"><A onClick="return change_option(5,1);return false;"  href="#">SSH实时监控</A></LI>
              <LI id="current2"><A onClick="return change_option(5,2);return false;"  href="#">Telnet实时监控</A></LI>
              <LI id="current3"><A onClick="return change_option(5,3);return false;"  href="#">RDP实时监控</A></LI>
              <LI id="current4"><A onClick="return change_option(5,4);return false;"  href="#">VNC实时监控</A></LI>
              <LI id="current5"><A onClick="return change_option(5,5);return false;"  href="#">WEB</A></LI></UL></DIV>
            <div id="tabbottom" > 
...
" href="#" onClick="return go('admin.php?controller=admin_session&action=monitor&ltype=<?php echo $_smarty_tpl->tpl_vars['ssh']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['type'];?>
&luser=<?php echo $_smarty_tpl->tpl_vars['ssh']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['luser'];?>
&tool=putty.Putty&pid=<?php echo $_smarty_tpl->tpl_vars['ssh']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['pid'];?>
.<?php echo $_smarty_tpl->tpl_vars['ssh']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['sid'];?>
...
<?php echo '<script'; ?>
>
change_option(5,<?php if ($_GET['item']) {
echo $_GET['item'];
} else { ?>1<?php }?>);
<?php echo '</script'; ?>
>
