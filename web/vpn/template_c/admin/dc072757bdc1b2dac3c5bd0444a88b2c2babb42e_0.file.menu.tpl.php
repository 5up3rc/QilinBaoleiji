<?php /* Smarty version 3.1.27, created on 2017-11-23 14:32:46
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/vpn/template/admin/menu.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:20345500715a166b8edf5996_16012007%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20345500715a166b8edf5996_16012007',
  'variables' => 
  array (
    'site_title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5a166b8f0ea1a7_47779366',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5a166b8f0ea1a7_47779366')) {
function content_5a166b8f0ea1a7_47779366 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '20345500715a166b8edf5996_16012007';
?>
...
/images/ico9.gif" width="18" height="21"  align="absmiddle"/> <a href="admin.php?controller=admin_member&action=edit_self" target="main" id="OwnInformation" onclick="return jumpto(this)"><?php echo $_smarty_tpl->tpl_vars['language']->value['OwnInformation'];?>
					...
					<tr>
                      <td height="25" align="left" bgcolor="52A1D4" class="zcd01"><img src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/list_ico4.gif" width="18" height="21"  align="absmiddle"/> <a href="admin.php?controller=admin_index&action=license" id="license" target="main" onclick="return jumpto(this)">License</a></td>
                    </tr>
					<?php }?>  
...
<?php } elseif ($_GET['actions'] == 'license') {?>
show_box('other');
jumpto(document.getElementById('license'));
document.getElementById('license').parentNode.className='zcd';
window.parent.document.getElementById('main').src='admin.php?controller=admin_index&action=license'+'&'+Math.round(new Date().getTime()/1000);
